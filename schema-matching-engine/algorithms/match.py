class Match:
    ...
    """
    def __init__(self,
                 target_table_name: str, target_table_guid: object, target_column_name: str, target_column_guid: object,
                 source_table_name: str, source_table_guid: object, source_column_name: str, source_column_guid: object,
                 similarity: float):
    ...
    @property
    def to_dict(self):
        return {"source": {"tbl_nm":  self.source_table_name, "tbl_guid": self.source_table_guid,
                           "clm_nm": self.source_column_name, "clm_guid": self.source_column_guid},
                "target": {"tbl_nm":  self.target_table_name, "tbl_guid": self.target_table_guid,
